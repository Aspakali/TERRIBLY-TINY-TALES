...
`}
                ...
                <div className="bg">
                    <img src={"/assets/river_bg.jpg"} alt="Background" />  
                </div>
                ...
                <div className="details">
                    <div className="first">
                        <div className="profile_picture">
                            <img src={"/assets/PP-Photo.jpg"} alt="Profile Picture" />
                        </div>
                    ...
                    <div className="second">
                        ...
                        <div className="stats">
                            <div className="allicon">
                                ...
                                <div className="icons">
                                    <img src={"/assets/yellow_like.jpg"} alt="like" />
                                    12
                                </div>
                                <div className="icons">
                                    <img src={"/assets/vision.png"} alt="views" />
                                    57.8k
                                </div>
                                <div className="icons">
            ...
            <div className="last">
                ...
                <div className="content">
                    <div className="first_content">
                        ...
                        <div className="icon">
                            <img src={"/assets/yellow_like.jpg"} alt="Logo" />
                        </div>
                    </div>
                    <div className="dec">
